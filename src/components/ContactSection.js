...
function ContactSection() {
  ...
  const accounts = {
    groom: [
      { name: '신랑 장한솔', account: '신한은행 110-436-365944' },
      { name: '신랑측 아버지 한상표', account: '신한은행 110-436-365944' },
      { name: '신랑측 어머니 이혜영', account: '신한은행 110-436-365944' },
    ],
    bride: [
      { name: '신부 김유진', account: '신한은행 110-436-365944' },
      { name: '신부측 아버지 김진석', account: '신한은행 110-436-365944' },
      { name: '신부측 어머니 이창섭', account: '신한은행 110-436-365944' },
    ],
  };
